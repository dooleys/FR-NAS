...
if __name__ == '__main__':
    ...
    parser.add_argument('--checkpoint',
                        default="backbone_ir50_ms1m_epoch63.pth")
    parser.add_argument(
        '--demographics',
    ...
    parser.add_argument('--file_name',
                        default='bias_celeba_balanced_ratio_cos.csv',
                        type=str)
    ...
    test_transform = transforms.Compose([
        transforms.Resize([
            int(128 * args.input_size[0] / 112),
            int(128 * args.input_size[1] / 112)
        ]),
    ...
    for s in args.seed:
        ...
        model_checkpoint_path = os.path.join('/cmlscratch/sdooley1/models/',
                                             args.checkpoint)
