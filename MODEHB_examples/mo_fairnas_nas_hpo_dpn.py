...
def get_configspace(seed=None):
    cs = CS.ConfigurationSpace(seed)
    edge1 = CSH.OrdinalHyperparameter("edge1", sequence=[0,1,2,3,4], default_value=1)
    edge2 = CSH.OrdinalHyperparameter("edge2", sequence=[0,1,2,3,4], default_value=1)
    edge3 = CSH.OrdinalHyperparameter("edge3", sequence=[0,1,2,3,4], default_value=1)
    edge4 = CSH.OrdinalHyperparameter("edge4", sequence=[0,1,2,3,4], default_value=1)
    edge5 = CSH.OrdinalHyperparameter("edge5", sequence=[0,1,2,3,4], default_value=1)
    edge6 = CSH.OrdinalHyperparameter("edge6", sequence=[0,1,2,3,4], default_value=1)
...
def main():
    ...
    modehb = MODEHB(objective_function=objective_function_, cs=cs, dimensions=dimensions, min_budget=args.min_budget,
                    max_budget=args.max_budget, eta=args.eta, output_path=args.output_path,
                    num_objectives=3, mo_strategy=args.mo_strategy,
